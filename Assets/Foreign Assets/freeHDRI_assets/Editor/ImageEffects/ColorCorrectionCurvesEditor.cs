...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class ColorCorrectionCurvesEditor : Editor {
        ...
        void CurveGui ( string name, SerializedProperty animationCurve, UnityEngine.Color color) {
        ...
        public override void OnInspectorGUI () {
            ...
            CurveGui(" Red", redChannel, UnityEngine.Color.red);
            CurveGui(" Green", greenChannel, UnityEngine.Color.green);
            CurveGui(" Blue", blueChannel, UnityEngine.Color.blue);
            ...
            if (useDepthCorrection.boolValue) {
                CurveGui(" Red (depth)", depthRedChannel, UnityEngine.Color.red);
                CurveGui(" Green (depth)", depthGreenChannel, UnityEngine.Color.green);
                CurveGui(" Blue (depth)", depthBlueChannel, UnityEngine.Color.blue);
                EditorGUILayout.Separator ();
                CurveGui(" Blend Curve", zCurveChannel, UnityEngine.Color.grey);
            }
