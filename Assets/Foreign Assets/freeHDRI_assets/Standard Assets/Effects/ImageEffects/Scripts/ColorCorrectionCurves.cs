        ...
        public void UpdateParameters ()
		{
            ...
            if (redChannel != null && greenChannel != null && blueChannel != null)
			{
                for (float i = 0.0f; i <= 1.0f; i += 1.0f / 255.0f)
				{
                    ...
                    rgbChannelTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 0, new UnityEngine.Color(rCh, rCh, rCh) );
                    rgbChannelTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 1, new UnityEngine.Color(gCh, gCh, gCh) );
                    rgbChannelTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 2, new UnityEngine.Color(bCh, bCh, bCh) );

                    float zC = Mathf.Clamp (zCurve.Evaluate(i), 0.0f,1.0f);

                    zCurveTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 0, new UnityEngine.Color(zC, zC, zC) );
                    ...
                    rgbDepthChannelTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 0, new UnityEngine.Color(rCh, rCh, rCh) );
                    rgbDepthChannelTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 1, new UnityEngine.Color(gCh, gCh, gCh) );
                    rgbDepthChannelTex.SetPixel ((int)Mathf.Floor(i * 255.0f), 2, new UnityEngine.Color(bCh, bCh, bCh) );
                }
