...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class Bloom : PostEffectsBase
    {
        ...
        public UnityEngine.Color flareColorD = new UnityEngine.Color (0.8f, 0.4f, 0.0f, 0.75f);
            ...
            for (int iter = 0; iter < bloomBlurIterations; iter++)
			{
                ...
                if (quality > BloomQuality.Cheap)
				{
                    if (iter == 0)
                    {
                        ...
                        GL.Clear(false, true, UnityEngine.Color.black); // Clear to avoid RT restore
        ...
        private void Vignette (float amount, RenderTexture from, RenderTexture to)
        {
            ...
            else if (from != to)
            {
                ...
                GL.Clear(false, true, UnityEngine.Color.black); // clear destination to avoid RT restore
